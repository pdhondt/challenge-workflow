...
class UserFixture extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $newFirstLineAgent->setRoles(['ROLE_AGENT_1']);
        ...
        $newSecondLineAgent->setRoles(['ROLE_AGENT_2']);
        ...
        $newAdmin->setRoles(['ROLE_ADMIN', 'ROLE_MANAGER', 'ROLE_AGENT_1', 'ROLE_AGENT_2', 'ROLE_CUSTOMER']);
